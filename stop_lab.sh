...
cd "challenges/A01_A06_Broken_Access+Insecure_Design" && docker-compose down && cd ../..
cd "challenges/A02_2025_Security_Misconfigurations" && docker-compose down && cd ../..
cd "challenges/A03_2025_Software_Supply_Chain_Failures" && docker-compose down && cd ../..
